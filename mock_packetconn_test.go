...
//
//	mockgen -typed -package quic -self_package github.com/malivvan/quic -self_package github.com/malivvan/quic -destination mock_packetconn_test.go net PacketConn
//
