...
// Source: github.com/malivvan/quic/http3 (interfaces: QUICListener)
//
// Generated by this command:
//
//	mockgen -typed -package http3 -destination mock_quic_listener_test.go github.com/malivvan/quic/http3 QUICListener
//
